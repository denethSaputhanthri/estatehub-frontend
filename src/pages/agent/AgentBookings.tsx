...
function AgentBookings() {
  ...
  const handleUpdateDate = async (
    ...
    if (!newDate || newDate === booking.visitDate) {
      return
    }
                ...
                <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                  ...
                  <div className="w-full lg:w-64">
                    <button
                      type="button"
                      onClick={() =>
                        handleUpdateDate(booking)
                      }
                      className="w-full rounded-lg border border-blue-500/30 px-4 py-3 text-sm font-medium text-blue-400 transition hover:bg-blue-500/10"
                    >
                      Reschedule Visit
                    </button>
